...
export default function() {
  ...
  <div data-placeholder="" class="xnote-content">
    ...
    <div data-component="TableComponent" data-layout-width="[151,223,337]" class="xnote-table">
      <div class="xnote-table-inner">
        <div class="xnote-table-container">
          <table class="xnote-table-content">
            <colgroup>
              <col style="width:151px;min-width:151px">
              </col>
              <col style="width:223px;min-width:223px">
              </col>
              <col style="width:337px;min-width:337px">
              </col>
            </colgroup>
            <tbody>
              <tr>
                <td rowspan="1" colspan="1" style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)"><span style="color:rgb(170, 170, 170)">模块名</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1" style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)"><span style="color:rgb(170, 170, 170)">包名</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1" style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div style="border-color:rgba(70, 70, 70, 1);background-color:rgba(0, 0, 0, 1)"><span style="color:rgb(170, 170, 170)">说明</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">内核模块</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/core</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">封装了富文本所需的组件、格式、选区、数据操作、历史记录、快捷键、语法糖等相关功能</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">浏览器模块</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/platform-browser</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 在浏览器运行所需要的基础模块</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">服务端模块</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/platform-node</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 在 node 环境支持所需要的基础模块</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Viewfly 视图适配器</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/adapter-viewfly</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 使用&nbsp;<a href="https://viewfly.org/" target="_blank" style="color:rgb(41, 110, 255)">Viewfly</a>&nbsp;作渲染实现时的适配器</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="background-color:rgba(255, 255, 255, 0.8);font-size:15px">Vue 视图适配器</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/adapter-vue</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 使用 Vue 作渲染实现时的适配器</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="background-color:rgba(255, 255, 255, 0.8);font-size:15px">React 视图适配器</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/adapter-react</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 使用 React 作渲染实现时的适配器</span></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">协作模块</span></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><strong style="color:rgb(18, 150, 219);font-size:15px">@textbus/collaborate</strong></div>
                  </div>
                </td>
                <td rowspan="1" colspan="1">
                  <div data-component="ParagraphComponent" class="xnote-paragraph">
                    <div><span style="font-size:15px">Textbus 协作能力支持模块（Yjs 版）</span></div>
                  </div>
                </td>
              </tr>
            </tbody>
