...
export default function() {
  ...
  <div data-placeholder="" class="xnote-content">
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <div>Textbus 还拥有超强的性能，在使用&nbsp;<a href="https://viewfly.org/" target="_blank">Viewfly</a>&nbsp;作为渲染层时，我们使用红楼梦作为测试样本，Textbus 可以实现&nbsp;<strong style="color:rgb(18, 150, 219)">5 万个段落无卡顿编辑，这相当于 15 本红楼梦共 1700 万字同时在一个文档内</strong>&nbsp;(一本红楼梦大约 3100 个段落），这在以前是不可想象的。</div>
    </div>
    <blockquote data-component="BlockquoteComponent" class="xnote-blockquote">
      <div>
        <div data-component="ParagraphComponent" class="xnote-paragraph">
          <div><strong style="color:rgb(255, 46, 46)">提示</strong>：从 4.0 开始，Textbus 仓库将不再提供默认的编辑器，不过我们重新开发了 XNote 富文本编辑器，仓库地址：<a href="https://github.com/textbus/xnote" target="_blanK">https://github.com/textbus/xnote</a>。你可以阅读文档并开发自己的编辑器，或者 github issue 留言咨询相关问题。</div>
        </div>
      </div>
    </blockquote>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
