  ...
  <div data-placeholder="" class="xnote-content">
    ...
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        ...
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/core</strong>&nbsp;Textbus 内核，封装了富文本所需的组件、格式、选区、数据操作、历史记录、快捷键、语法糖等相关功能</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/platform-browser</strong>&nbsp;Textbus 在浏览器运行所需要的基础模块</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/platform-node</strong>&nbsp;Textbus 在 node 环境支持所需要的基础模块</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/collaborate</strong>&nbsp;Textbus 协作能力支持模块（Yjs 版）</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/adapter-viewfly</strong>&nbsp;Textbus 使用&nbsp;<a href="https://viewfly.org/" target="_blank">Viewfly</a>&nbsp;作渲染实现时的适配器</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/adapter-vue</strong>&nbsp;Textbus 使用 Vue 作渲染实现时的适配器</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:#1296db">@textbus/adapter-react</strong>&nbsp;Textbus 使用 React 作渲染实现时的适配器</div>
      </li>
    </ul>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
