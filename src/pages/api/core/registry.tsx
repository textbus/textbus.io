...
export default function() {
  ...
  <div data-placeholder="" class="xnote-content">
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h1">Registry 注册表</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">getComponent() 获取组件</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p>根据名字获取组件。</p>
    </div>
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">getFormatter() 获取格式实例</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p>根据名字获取格式。</p>
    </div>
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">getAttribute() 获取属性实例</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p>根据名字获取属性。</p>
    </div>
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">createComponentByData() 创建组件</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">createSlot() 创建插槽</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">createComponent() 创建组件</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">createComponentByFactory() 创建组件</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p>根据指定数据和组件创建实例。</p>
    </div>
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p class="xnote-h2">fillSlot() 填充插槽</p>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <p>根据源插槽数据，填充到目标插槽。</p>
    </div>
